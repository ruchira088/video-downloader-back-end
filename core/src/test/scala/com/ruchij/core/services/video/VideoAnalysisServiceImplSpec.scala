    ...
    analyze[IO](uri"https://www.youtube.com/watch?v=2Vv-BfVoq4g&list=RDMM-fR-duU1Qjk&start_radio=1")
      .semiflatMap { videoAnalysisResult =>
        IO.delay {
          ...
          videoAnalysisResult.thumbnail.copy(query = Query.empty) mustBe
            oneOf(uri"https://i.ytimg.com/vi/2Vv-BfVoq4g/sddefault.jpg", uri"https://i.ytimg.com/vi_webp/2Vv-BfVoq4g/sddefault.webp")
