...
object Dependencies
{
  ...
  lazy val jsoup = "org.jsoup" % "jsoup" % "1.21.2"
  ...
  lazy val redis4CatsEffects = "dev.profunktor" %% "redis4cats-effects" % "2.0.2"

  lazy val netty = "io.netty" % "netty-all" % "4.2.9.Final"
  ...
  lazy val scalaMock = "org.scalamock" %% "scalamock" % "7.5.2"
