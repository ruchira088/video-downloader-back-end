...
object Dependencies
{
  ...
  private val FlywayVersion = "12.4.0"
  ...
  lazy val enumeratum = "com.beachape" %% "enumeratum" % "1.9.7"
  ...
  lazy val testContainers = "org.testcontainers" % "testcontainers" % "2.0.4"
  ...
  lazy val sentry = "io.sentry" % "sentry" % "8.39.1"
