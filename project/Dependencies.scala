...
object Dependencies
{
  ...
  lazy val flywayCore = "org.flywaydb" % "flyway-core" % "9.15.1"
  ...
  lazy val embeddedKafkaSchemaRegistry = "io.github.embeddedkafka" %% "embedded-kafka-schema-registry" % "7.3.2.1"
