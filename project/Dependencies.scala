...
object Dependencies
{
  ...
  lazy val flywayCore = "org.flywaydb" % "flyway-core" % "9.14.1"

  lazy val postgresql = "org.postgresql" % "postgresql" % "42.5.3"
  ...
  lazy val embeddedKafkaSchemaRegistry = "io.github.embeddedkafka" %% "embedded-kafka-schema-registry" % "7.3.2"
